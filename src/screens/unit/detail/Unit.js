...
class FormUnit extends Component {
  ...
  render() {
    ...
    return (
      <Container>
        <CustomHeader navigation={navigation} title="Unit" />
...
const mapStateToProps = state => ({
  savedData: state.saveUnit.data,
  saveError: state.saveUnit.error,
  data: state.unitId.data,
  loading: state.unitId.loading || state.saveUnit.loading,
  error: state.unitId.error
});
