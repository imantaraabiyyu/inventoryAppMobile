...
class UnitSearch extends Component {
  ...
  onShowForm = item => {
    this.props.navigation.navigate('FormUnit', item ? { id: item.id } : null);
  };
  render() {
    ...
    return (
      <Container>
        <CustomHeader navigation={navigation} title="Units" />
...
const mapStateToProps = state => ({
  data: state.unitsSearch.data,
  loading: state.unitsSearch.loading,
  error: state.unitsSearch.error
});
